...
li.className = "variant1";
var questions = document.querySelector(".questions");
questions.appendChild(li);
li.innerHTML = "Question#1"

var li = document.createElement("li");
li.className = "variant2";
var questions = document.querySelector(".questions");
questions.appendChild(li);
li.innerHTML = "Question#2"

var li = document.createElement("li");
li.className = "variant3";
var questions = document.querySelector(".questions");
questions.appendChild(li);
...
ul.className = "link";
var variant1 = document.querySelector(".variant1");
variant1.appendChild(ul);
...
variant2.appendChild(ul);

var li = document.createElement('li');
li.className = "checkin4";
...
var ul = document.createElement('ul');
ul.className = "link3";
var variant3 = document.querySelector(".variant3");
variant3.appendChild(ul);

var li = document.createElement('li');
li.className = "checkin7";
